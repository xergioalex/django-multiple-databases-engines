...
ENV_FILES=(".env" "django/.env" "nginx/.env" "nginx/nginx.conf" "nginx/crons/renewssl.sh" "nginx/crons/crontab" "../../uwsgi.ini" "../../uwsgi.log" "postgres/.env" "mysql/.env" "sqlserver/.env" "mongo/.env" "couchdb/.env" "cassandra/.env" "neo4j/.env")
